...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgCollie.jpeg"))); // NOI18N
    ...
    public void cargarDatos(int numCliente){
        masco=control.traerMascota(numCliente);
        duenio=control.traerDuenio(masco.getDuenio().getId_duenio());
        txtNombre.setText(masco.getNombre());
        txtColor.setText(masco.getColor());
        txtRaza.setText(masco.getRaza());
        txtNomDueño.setText(masco.getDuenio().getNombre());
        txtCelDueño.setText(masco.getDuenio().getCel_duenio());
        ...
        if (masco.getAtEspecial().equals("Si")) {
            cmbAteEsp.setSelectedIndex(1);
        }else if (masco.getAtEspecial().equals("No")) {
            cmbAteEsp.setSelectedIndex(2);
        }
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        duenio.setNombre(txtNomDueño.getText());
        duenio.setCel_duenio(txtCelDueño.getText());
        control.editarDuenio(duenio);
        
        masco.setNombre(txtNombre.getText());
        masco.setRaza(txtRaza.getText());
        masco.setColor(txtColor.getText());
        masco.setAlergico((String) cmbAlergico.getSelectedItem());
        masco.setAtEspecial((String) cmbAteEsp.getSelectedItem());
        masco.setObservaciones(txtObservaciones.getText());
